...
public class ShapeRectangle extends Shape {
	public static ShapeRectangle createShapeRectangle(int _startx, int _starty, int _endx, int _endy) {
		return new ShapeRectangle(_startx, _starty, _endx, _endy);
	}	
	private ShapeRectangle(int _startx, int _starty, int _endx, int _endy) {
